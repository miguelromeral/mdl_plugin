...
$string['exercise_not_deleted'] = 'No se ha podido eliminar el ejercicio. Deshabilítelo y deje de publicar sus notas primero.';
...
$string['teacher_panel'] = 'Panel de control del profesor';
